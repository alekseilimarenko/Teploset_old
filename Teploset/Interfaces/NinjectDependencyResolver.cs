...
namespace Teploset.Interfaces
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            {
                new News {  DateTimeCreate = DateTime.Parse("06/02/2017"),
                ...
                new News {  DateTimeCreate = DateTime.Parse("30/01/2017"),
                            NewsTitle = "Обращение к жителям г.Запорожье",
                ...
                new News {  DateTimeCreate = DateTime.Parse("04/01/2017"),
                            NewsTitle = "До уваги мешканців міста Запоріжжя, будинки яких не обладнані теплолічильниками!",
                ...
                new News {  DateTimeCreate = DateTime.Parse("06/02/2017"),
                            NewsTitle = "До уваги бюджетних установ",
                            NewsBody = "КОНЦЕРН „Міські теплові мережі” інформує, що постановою Національної комісії, що здійснює державне регулювання " +
                                       "у сферах енергетики та комунальних послуг(НКРЕКП)  від 29.12.2016р. № 2439 «Про внесення змін до деяких постанов " +
                                       "НКРЕКП» Концерну „Міські теплові мережі” встановлено тариф на теплову енергію, її виробництво, транспортування," +
                                       " постачання для потреб: - бюджетних установ на рівні: " +
                                       ...
                                       "-     тариф на транспортування теплової енергії – 30,40 грн/Гкал(без ПДВ);" +
                                       "-     тариф на постачання теплової енергії – 5,14 грн/Гкал(без ПДВ). Структура тарифів на послуги з " +
                                       "централізованого постачання гарячої води Концерну \"МТМ\" наведена в додатку 12 до постанови НКРЕКП від 29.12.2016 №2439." +
                                       "Постановою Національної комісії, що здійснює державне регулювання у сферах енергетики та комунальних послуг(НКРЕКП) " +
                                       "від 29.12.2016р. № 2440 «Про внесення змін до постанови Національної комісії, що здійснює державне регулювання у сферах " +
                                       "енергетики та комунальних послуг від 30.04.2015р. №1543» Концерну „Міські теплові мережі” встановлено тариф на послугу з " +
                                       "централізованого постачання гарячої води:" +
                                       "-         для потреб бюджетних установ – 59,38  грн.за 1 куб.м  (без ПДВ);" +
                                       "Структура тарифів на послуги з централізованого постачання гарячої води Концерну \"МТМ\" наведена в додатку 14 до" +
                                       " постанови НКРЕКП від 29.12.2016 № 2440. Дані постанови набирають чинності з дня, наступного за днем її опублікування " +
                                       "в офіційному друкованому виданні – газеті «Урядовий кур'єр»."
                         }
            });
